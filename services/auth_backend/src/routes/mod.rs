...
#[openapi(
    ...
    components(
        schemas(
            backend_common::auth::RegisterInput,
            backend_common::auth::LoginInput,
            backend_common::auth::UpdateProfileInput,
            backend_common::auth::AddRecoveryInfoInputs,
            backend_common::auth::VerifyRecoveryInfoInputs,
            backend_common::auth::VerifyRecoveryInfoOutputs,
            crate::routes::user::UserSearchResult,
            backend_common::auth::ByIdsInput,
